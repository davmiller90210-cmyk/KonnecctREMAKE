      ...
      <StyledShell>
        <StyledFallback>
          <Callout
            ...
            description="Set FRONT_URL (or REACT_APP_MATTERMOST_WEBAPP_URL) on the API so the iframe can load team chat, or open the chat path on the same host: /_konnecct/mattermost"
          />
        </StyledFallback>
      </StyledShell>
    );
