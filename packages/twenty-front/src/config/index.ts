const getDefaultUrl = () => {
  if (
    ...
    // In prod context, we use index.html + window var to overwrite it
...
/**
 * Sendbird App ID — required for the Communications Hub.
 * Set REACT_APP_SENDBIRD_APP_ID in your .env (or window._env_).
 */
